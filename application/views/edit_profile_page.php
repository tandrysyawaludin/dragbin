		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item active">
					<a class="nav-link" href="<?php echo base_url()?>index.php/profile">Profile <span
							class="sr-only">(current)</span></a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="<?php echo base_url()?>index.php/transaction-list">Transaction</a>
				</li>
			</ul>
			<a href="<?php echo base_url(), "index.php/signin/revoke_auth_authentication" ?>"
				class="btn btn-outline-secondary my-2 my-sm-0" role="button">Sign Out</a>
		</div>
	</nav>
		...
		<div class="row">
            ...
            <?php } ?>
						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<input class="form-control-file" id="photo" value="<?php echo $user['photo'] ?>" type="file"
									name="photo">
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<input class="form-control" id="phone_number" value="<?php echo $user['phone_number'] ?>"
									name="phone_number">
							</div>
						</div>
