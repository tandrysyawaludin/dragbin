			...
			<div class="col-md-8 offset-md-2 col-sm-12">
				...
				<div class="media mt-4 post-container">
					<div class="media-body">
						<h5 class="mt-0 mb-4">Pengajuan <span
								class="badge badge-<?php echo $user['is_blocked'] ? "secondary" : "success" ?>">
              <?php 
              ...
              ?></span>
						...
						<div class="alert alert-warning" role="alert">
							Akun anda belum terdaftar sebagai MITRA KAMI, silahkan hubungi syawaludintandry@gmail.com untuk pengauan
							kemitraan
						</div>
                    ...
                    foreach($unchecked_categories as $unchecked_category) { ?>
                      ...
                      <?php } ?>
						...
						<div class="form-group">
							<div class="col-sm-12">
								<a href="user-post/edit-post" class="form-control btn btn-warning">Ubah</a>
							</div>
						</div>
					</div>
				</div>
